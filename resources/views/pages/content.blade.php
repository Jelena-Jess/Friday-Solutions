  ...
  <section class="col-12 py-5 text-justify bg-grey">
    <div class="main py-5">
      ...
      <div class="d-flex flex-column align-items-center pt-4">
        ...
        <p>Content equals business growth. So, let’s get started with your content strategy.</p>
        </div>
        <div>
          ...
          <p>Set Your Content Goals
            ...
            The Ultimate Google AdWords and PPC Kit
            ...
            Audience Growth: the new subscribers or leads that are generated from a piece of content. </p>
        </div>
